...
class LLMInputOutputAdapter:
    ...
    def prepare_input(
        ...
        if provider == "anthropic" or provider == "ai21" or provider == "meta":
            ...
            input_body = dict()
            input_body["messages"] = list()
            input_body["messages"].append(message)
        else:
            input_body["inputText"] = prompt
...
class Bedrock(LLM):
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        # Our custom stop sequences to enforce
        stop = ["\nHuman:", "\nObservation:", "\nNew input:", "</s>"]
